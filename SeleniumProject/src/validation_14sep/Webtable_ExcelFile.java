...
public class Webtable_ExcelFile {
    ...
    public static void webtableToExcel(){
        ...
        try{
            ...
            oBrowser.navigate().to("file:///C:/Users/Admin/OneDrive/Documents/SampleWebTable.html");
            Thread.sleep(2000);
            ...
            fout = new FileOutputStream("C:\\Users\\Admin\\OneDrive\\Documents\\StudentDetails.xlsx");
            wb.write(fout);
        }catch(Exception e){
            e.printStackTrace();
        }finally{
